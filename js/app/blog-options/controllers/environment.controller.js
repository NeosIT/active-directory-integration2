    ...
    function EnvironmentController($rootScope, $scope, $http, ListService, DataService, ngNotify) {
        ...
        $scope.$on('options', function (event, data) {
            $scope.option = {
                ...
                allow_self_signed: $valueHelper.findValue("allow_self_signed", data),
            ...
            $scope.permission = {
                ...
                allow_self_signed: $valueHelper.findPermission('allow_self_signed', data),
        ...
        $scope.$on('validation', function (event, data) {
            $scope.messages = {
                ...
                allow_self_signed: $valueHelper.findMessage('allow_self_signed', data),
