    ...
    function GeneralController($scope, DataService) {
        ...
        $scope.$on('options', function (event, data) {
            $scope.option = {
                ...
                support_id: $valueHelper.findValue('support_id', data),
            ...
            $scope.permission = {
                support_id: $valueHelper.findPermission('support_id', data),
        ...
        $scope.$on('validation', function (event, data) {
            $scope.messages = {
                ...
                support_id: $valueHelper.findMessage('support_id', data),
