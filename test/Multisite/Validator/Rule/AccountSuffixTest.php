...
if (class_exists('Ut_Multisite_Validator_Rule_AccountSuffixTest')) {
	return;
}

class Ut_Multisite_Validator_Rule_AccountSuffixTest extends Ut_BasicTest
{
	 ...
	 * @param $methods
	 *
	 * @return Multisite_Validator_Rule_AccountSuffix|PHPUnit_Framework_MockObject_MockObject
	 */
	public function sut($methods = null)
	{
		return $this->getMockBuilder('Multisite_Validator_Rule_AccountSuffix')
			->setConstructorArgs(
				array(
