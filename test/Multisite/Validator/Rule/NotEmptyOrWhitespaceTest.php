...
if (class_exists('Ut_Multisite_Validator_Rule_NotEmptyOrWhitespaceTest')) {
	return;
}
 ...
 * @access
 */
class Ut_Multisite_Validator_Rule_NotEmptyOrWhitespaceTest extends Ut_BasicTest
{
	 ...
	 * @param $msg string
	 *
	 * @return Multisite_Validator_Rule_Numeric|PHPUnit_Framework_MockObject_MockObject
	 */
	public function sut($methods = null)
	{
		return $this->getMockBuilder('Multisite_Validator_Rule_NotEmptyOrWhitespace')
			->setConstructorArgs(
				array(
