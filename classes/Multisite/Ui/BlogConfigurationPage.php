...
class NextADInt_Multisite_Ui_BlogConfigurationPage extends NextADInt_Multisite_View_Page_Abstract
{
	...
	protected function loadSharedAdminScriptsAndStyle()
	{
		...
		wp_enqueue_script('adi2_page', ADI_URL . '/js/page.js', array('jquery'), NextADInt_Multisite_Ui::VERSION_PAGE_JS);
		...
		wp_enqueue_script('adi2_app_module', ADI_URL . '/js/app/app.module.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS);
		wp_enqueue_script('adi2_app_config', ADI_URL . '/js/app/app.config.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS);

		// add the service js files
		wp_enqueue_script(
			'adi2_shared_service_browser',
			ADI_URL . '/js/app/shared/services/browser.service.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS
		);
		wp_enqueue_script(
			'adi2_shared_service_template',
			ADI_URL . '/js/app/shared/services/template.service.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS
		);
		wp_enqueue_script(
			'adi2_shared_service_notification',
			ADI_URL . '/js/app/shared/services/notification.service.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS
		);
		wp_enqueue_script(
			'adi2_shared_service_list',
			ADI_URL . '/js/app/shared/services/list.service.js', array(), NextADInt_Multisite_Ui::VERSION_PAGE_JS
		);
		...
		wp_enqueue_style('ng-notify', ADI_URL . '/css/ng-notify.min.css', array(), NextADInt_Multisite_Ui::VERSION_CSS);
		wp_enqueue_style('selectizecss', ADI_URL . '/css/selectize.css', array(), NextADInt_Multisite_Ui::VERSION_CSS);
		wp_enqueue_style('alertify.min', ADI_URL . '/css/alertify.min.css', array(), NextADInt_Multisite_Ui::VERSION_CSS);
	}
