...
if (class_exists('NextADInt_Core_LegacyEncryption')) {
	return;
}

/**
 * NextADInt_Core_LegacyEncryption provides the method to decrypt
 * credentials e.g for the synchronization between WordPress and Active Directory users.
 * This class uses mcrypt for decryption and is not compatible with PHP 7.1.
 *
 * @author Tobias Hellmann <the@neos-it.de>
 * @access public
 */
class NextADInt_Core_LegacyEncryption
{
	const KEY_HASH = 'md5';
