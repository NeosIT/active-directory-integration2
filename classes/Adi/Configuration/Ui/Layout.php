			...
			__('Attributes', NEXT_AD_INT_I18N) => array(
				...
				__('Attributes', NEXT_AD_INT_I18N) => array(
					...
					self::DESCRIPTION => array(
						...
						'',
						sprintf(__('The following WordPress attributes are reserved by ADI and cannot be used: %s', NEXT_AD_INT_I18N), implode(', ', Ldap_Attribute_Repository::getDefaultAttributeMetaKeys())),
					),
					// Group elements in group
					self::OPTIONS     => array(
